/**
 * EXAMPLE: Room 9 Refactored to use Portal Utilities
 *
 * This demonstrates how room9.js could be simplified by using the new
 * portal-utils.js module. This is a before/after comparison.
 *
 * BEFORE: ~240 lines with manual portal creation
 * AFTER: ~210 lines with utilities (15% reduction)
 *
 * Benefits:
 * - Standardized portal behavior across all rooms
 * - Less code to maintain
 * - Easier to update portal logic globally
 * - Consistent color scheme via PORTAL_COLORS
 */
...
// ===================================================================
// PORTAL CREATION - BEFORE (Old Way - ~35 lines)
// ===================================================================
/*
...
// ===================================================================
// PORTAL CREATION - AFTER (New Way - ~8 lines using utilities)
// ===================================================================
...
const checkPortalProximity = createPortalProximityChecker({
  camera,
  portalPosition: new THREE.Vector3(0, eyeHeight, CORRIDOR_LENGTH / 2 - 2),
...
function animate() {
  ...
  if (controls.isLocked) {
    ...
    // Check portal proximity (using utility)
    checkPortalProximity();
  }

  // Animate portal (using utility)
