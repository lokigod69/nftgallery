document.addEventListener('DOMContentLoaded', function() {
  ...
  // Ensure Room 8 link exists in the menu
  if (!menu.querySelector('a[href="room8.html"]')) {
    const li = document.createElement('li');
    const link = document.createElement('a');
    link.href = 'room8.html';
    link.textContent = 'Room 8';
    li.appendChild(link);
    menu.appendChild(li);
  }
  ...
  // Ensure Room X link exists in the menu
  if (!menu.querySelector('a[href="room10.html"]')) {
    const li = document.createElement('li');
    const link = document.createElement('a');
    link.href = 'room10.html';
    link.textContent = 'Room X';
    li.appendChild(link);
    menu.appendChild(li);
  }
